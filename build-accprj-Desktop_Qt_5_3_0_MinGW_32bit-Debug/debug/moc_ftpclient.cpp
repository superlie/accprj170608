...
#include "../../accprj/tools/ftpclient.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FtpClient_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 43, 5)
    ...
    "FtpClient\0downloadFinished\0\0QNetworkReply*\0"
    "reply"
};
...
const QMetaObject FtpClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FtpClient.data,
      qt_meta_data_FtpClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FtpClient.stringdata))
