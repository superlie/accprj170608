/****************************************************************************
** Meta object code from reading C++ file 'ftpdownloader.h'
**
...
#include "../../accprj/tools/ftpdownloader.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ftpdownloader.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_FtpDownloader_t {
    QByteArrayData data[5];
    char stringdata[53];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FtpDownloader_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FtpDownloader_t qt_meta_stringdata_FtpDownloader = {
    {
...
QT_MOC_LITERAL(4, 47, 5)
    ...
    "FtpDownloader\0downloadFinished\0\0"
...
const QMetaObject FtpDownloader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FtpDownloader.data,
      qt_meta_data_FtpDownloader,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FtpDownloader.stringdata))
