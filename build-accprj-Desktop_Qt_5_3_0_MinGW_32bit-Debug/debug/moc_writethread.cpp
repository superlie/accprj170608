...
#include "../../accprj/maincontrol/writethread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WriteThread_t, stringdata) + ofs \
...
const QMetaObject WriteThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_WriteThread.data,
      qt_meta_data_WriteThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WriteThread.stringdata))
