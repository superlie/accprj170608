...
#include "../../accprj/tools/ftpuploader.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FtpUploader_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 43, 5)
    ...
    "FtpUploader\0uploadFinished\0\0QNetworkReply*\0"
    "reply"
};
...
void FtpUploader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->uploadFinished((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject FtpUploader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FtpUploader.data,
      qt_meta_data_FtpUploader,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FtpUploader.stringdata))
        return static_cast<void*>(const_cast< FtpUploader*>(this));
